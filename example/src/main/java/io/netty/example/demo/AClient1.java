...
public class AClient1 {
    ...
    public AClient1(String hostIp,int hostPort)throws Exception{
        this.hostIp=hostIp;
    ...
    public void init()throws Exception{
        ...
        //启动读取线程
        new AClientTcpClientReadThread(selector);
    ...
    static AClient1 aClient;
    static  boolean mFlag=true;

    public static void main(String[]args)throws Exception{
        aClient=new AClient1("127.0.0.1",9999);
