...
public class AServerTcpProtocal {
    ...
    public void handleAccept(SelectionKey key) throws Exception{
        ...
        //注册到selector
        //clientChannel 服务端负责与客户端 进行通信的 SocketChannel
        //        clientChannel.register(key.selector(),SelectionKey.OP_READ, ByteBuffer.allocate(bufferSize));
        //将与客户端联系的SocketChannel 注册到 ServerSocketChannel 对应的selector
        clientChannel.register(key.selector(),SelectionKey.OP_READ, ByteBuffer.allocateDirect(bufferSize));
